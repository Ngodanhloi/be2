                                ...
                                <div class="tab-pane active">
                                    <div class="productDes__ratting">
                                        ...
                                        <div class="productDes__ratting-wrap">
                                            <form id="commentForm" action="{{ route('binhluan.store') }}" method="POST">
                                                @csrf
                                                ...
                                                <textarea class="ratecomment" name="binhluan" id="" cols="30" rows="1"
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#commentForm').on('submit', function (e) {
                        ...
                        $.ajax({
                            url: "{{ route('binhluan.store') }}", // Route xử lý lưu bình luận
                            type: "POST",
                            ...
                            success: function (response) {
                                if (response.success) {
                                    ...
                                    const newComment = `
                                        <div class="binhluan-item">
                                            <div class="binhluan-header">
                                                ...
                                                <div class="star-rating" style="font-size: 20px; color: #FFD700;padding-left: 70px;">
                                                    ${'&#9733;'.repeat(binhluan.sao)}${'&#9734;'.repeat(5 - binhluan.sao)}
                                                </div>
                                                <p class="created-at" style="padding-left: 70px;">
                                                    ${new Date(binhluan.created_at).toLocaleString()}
                                                </p>
                                            </div>
                                            <p class="binhluan-content" style="padding-left: 70px;font-size: 1.8rem;">
                                                ${binhluan.binhluan}
                                    ...
                                    `;
                                    $('.binhluan-list').prepend(newComment); // Thêm bình luận mới lên đầu danh sách
                            ...
                            error: function (xhr) {
                                console.error(xhr.responseText); // Log lỗi để kiểm tra
                                alert('Có lỗi xảy ra, vui lòng thử lại.');
                            }
                        });
                    });
