    ...
    <main>
        ...
        <section id="products-section" class="admin-section">
            ...
            <div id="popupForm" style="display: none;">
                <form id="addProductForm" action="{{ route('admin.them.store') }}" method="POST"
            ...
            @isset($sanphams)
                @if ($sanphams->count())
                    <form method="GET" action="{{ route('admin.listpro') }}" class="search-container">
                        <input type="text" name="keyword" value="{{ request('keyword') }}"
                            placeholder="Tìm kiếm theo tên sản phẩm..." id="searchInput">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit-button btn btn-sm btn-warning"
                                            data-product-id="{{ $pro->sanpham_id }}">Edit</button>

                                        <form action="{{ route('admin.listpro.delete', ['sanpham_id' => $pro->sanpham_id]) }}"
                                    ...
                                    <div id="editFormContainer-{{ $pro->sanpham_id }}" class="edit-form-container"
                                        style="display: none;">
                                        <form action="{{ route('admin.crudSanPham.updatepro', $pro->sanpham_id) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label for="ten-{{ $pro->sanpham_id }}">Tên sản phẩm:</label>
                                                <input type="text" id="ten-{{ $pro->sanpham_id }}" name="ten"
                                                    value="{{ $pro->ten }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="mota-{{ $pro->sanpham_id }}">Mô tả:</label>
                                                <input id="mota-{{ $pro->sanpham_id }}" type="hidden" name="mota"
                                                    value="{{ $pro->mota }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="gia-{{ $pro->sanpham_id }}" name="gia"
                                                    value="{{ $pro->gia }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="sale-{{ $pro->sanpham_id }}">Sale (%):</label>
                                                <input type="number" id="sale-{{ $pro->sanpham_id }}" name="sale"
                                                    value="{{ $pro->sale ?? 0 }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="soluongtrongkho-{{ $pro->sanpham_id }}"
                                                    name="soluongtrongkho" value="{{ $pro->soluongtrongkho }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="soluongdaban-{{ $pro->sanpham_id }}">Số lượng đã bán:</label>
                                                <input type="number" id="soluongdaban-{{ $pro->sanpham_id }}" name="soluongdaban"
                                                    value="{{ $pro->soluongdaban }}" required>
                                            </div>
